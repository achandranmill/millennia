...
//---------------------------------------MY DOCUMENT ---------------------------------------------------------------------------
	...
	@FindBy(how=How.CSS,using="#rc-anchor-container > div.rc-anchor-normal-footer > div.rc-anchor-logo-portrait > div.rc-anchor-logo-img.rc-anchor-logo-img-portrait")
	@CacheLookup
	WebElement Robot;
	...
	@FindBy(how=How.CSS,using="#getInLineRegistration > div.container.max-width-700.min-height--300.ng-scope > div:nth-child(2) > div > div > get-in-line-form > div.ng-scope > get-in-line-form-body > div.panel-footer > div > button")
	@CacheLookup

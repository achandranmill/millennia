...

{
     ...
     @FindBy(how=How.XPATH,using="/html/body/main/div[1]/admin-organization/div/div[2]/organization-flags/jfh-add-flag/form/div/div/div[1]/jfh-simple-image-upload-cropper/div/div[2]/div[2]/label")
     @CacheLookup
     WebElement images;
     
     public void images()
     {
    	 WebElement upload_file = ldriver.findElement(By.xpath("/html/body/main/div[1]/admin-organization/div/div[2]/organization-flags/jfh-add-flag/form/div/div/div[1]/jfh-simple-image-upload-cropper/div/div[2]/div[2]/label"));  
    	 upload_file.sendKeys("C:\\Users\\ATM\\Desktop\\sher.jpg");
     }
     ...
     public void TextMessageContent(String t)
    {
     ...
     @FindBy(how=How.ID,using="fieldTitle")
     @CacheLookup
     ...
     @FindBy(how=How.XPATH,using="/html/body/main/div[1]/admin-organization/div/div[2]/documents/div/div[2]/survey-list/div/section/ul/li[5]/button/i")
     @CacheLookup
    ...
    @FindBy(how=How.XPATH,using="/html/body/main/div[1]/admin-organization/div/div[2]/patient-intake-config/section/div[2]/div/div[1]/div/div[4]/table/tbody/tr/td[1]/input")
    @CacheLookup
    ...
    public void PatientIntaketabInsurancename(String in)
    {
     ...
     @FindBy(how=How.XPATH,using="//*[@id=\"chartContainer\"]/patient-intake-config/section/div[2]/div/div[1]/div/div[4]/table/tbody/tr/td[2]/input")
     @CacheLookup
     ...
     @FindBy(how=How.XPATH,using="//*[@id=\"chartContainer\"]/patient-intake-config/section/div[2]/div/div[1]/div/div[4]/table/tbody/tr/td[3]/button")
     @CacheLookup
     ...
     @FindBy(how=How.XPATH,using="//*[@id=\"chartContainer\"]/patient-intake-config/section/div[2]/div/div[1]/div/div[4]/table/tbody/tr[1]/td[3]/button")
     @CacheLookup

...

{
	...
	@FindBy(how=How.XPATH,using="/html/body/main/div[1]/add-edit-provider/section/div/div/div[3]/div/div[2]/provider-schedule/section/form/div[2]/button")
	@CacheLookup
	...
	public void EditDepartmentnull()
	{
		...
		drop.selectByVisibleText("Imenso");
	}
	...
	public void EditAppointmentType()
	{
		...
		Appointment.selectByVisibleText("New Appointment");
	}

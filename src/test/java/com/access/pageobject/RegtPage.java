...
public class RegtPage
	...
	public void APPTLOCATION(String arg)
	{
		...
		@FindBy(how=How.XPATH,using="//label[@for='file-6']")
		@CacheLookup
		...
		@FindBy(how=How.XPATH,using="//label[@for='file-7' ]")
		@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//input[@name='Last Name_formly_1_lastName_1_1, lname']")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//input[@name='DOB_formly_1_dob_2_2, date-of-birth']")
	@CacheLookup
	WebElement RCB_Dob;
	...
	@FindBy(how=How.XPATH,using="//input[@name='SSN_formly_1_full_ssn_3_3']")
	@CacheLookup
	WebElement RCB_Ssn;
	...
	@FindBy(how=How.XPATH,using="//input[@name='Patient Street Address_formly_1_streetAddress_4_4, street-address']")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//input[@name='Zip Code_formly_1_postalCode_5_5, postal']")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="/html/body/pdf-viewer//viewer-toolbar//div/div[3]/cr-icon-button[2]//div")
	@CacheLookup

...
public class Clipboard {
	...
	@FindBy(how=How.XPATH,using="//date-picker[@name=\"appointmentDate\"]//input[@class=\"form-control ng-pristine ng-valid ng-isolate-scope ng-valid-mask ng-not-empty ng-valid-required ng-valid-date ng-touched\"]")
	@CacheLookup
	WebElement Date;
	...
	@FindBy(how=How.XPATH,using="//input[@placeholder='__:__']")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//button[@id=\\\"location-dropdown\\\"]//following::ul//div//following::li//a//span[contains(text(),'Imenso')]")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//li//a//span[contains(text(),'New Appointment')]")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//li//a//span[contains(text(),'Test_2, Provider')]")
	@CacheLookup
	...
	@FindBy(how=How.ID,using="btn-append-to-single-button")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//button[contains(text(),'Patient is Self')]")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using= "//a//span[contains(text(),'Patient is my Child')]")
	@CacheLookup
	...
	@FindBy(how=How.XPATH,using="//button[@id=\"location-dropdown\"]")
	...
	@FindBy(how=How.XPATH,using="//input[@name='appointmentDate']")
	@CacheLookup

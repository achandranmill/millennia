...

{
	...
	public void MassMessaging() throws Exception
	{
		...
		m.StatusFilterSave();
		Thread.sleep(3000);
		WebElement EligibleMe = driver.findElement(By.xpath("//a[contains(text(),'Eligible for message')] "));
		Assert.assertEquals(true, EligibleMe.isDisplayed());
		System.out.println("Eligible is Dispalyed- ASSERT PASSED");
		m.Eligible();
		Thread.sleep(3000);
	}
}

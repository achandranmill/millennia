...
public class Department_Reg_tc_86 extends BaseClass {
	...
	public void departments() throws InterruptedException, AWTException 
	{
		...
		dept.regemail();
		Thread.sleep(5000);
		dept.regemailfieldsize();
		Thread.sleep(5000);
		dept.regemailtitle("Email");
		Thread.sleep(5000);
		dept.regemailplaceholder("Email Test");
		Thread.sleep(5000);
		dept.regemailrequired();
		Thread.sleep(5000);

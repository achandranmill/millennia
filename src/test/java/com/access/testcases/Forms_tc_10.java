...
@Test
public class Forms_tc_10 extends BaseClass

{
	public void Appointments() throws Exception
	{
		...
		Thread.sleep(5000);
		clip.cliplastname("Singh");
		Thread.sleep(5000);
		clip.clipfirstname("Hari");
		Thread.sleep(5000);
		clip.clipmiddlename("Das");
		Thread.sleep(5000);
		clip.clipemail("hari@mailinator.com");

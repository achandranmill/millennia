...
@Test
public class Forms_tc_15 extends BaseClass

{
	public void Appointments() throws Exception
	{
		...
		Thread.sleep(5000);
		clip.cliplastname("Disuza");
		Thread.sleep(5000);
		clip.clipfirstname("John");
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		clip.clipemail("john3@mailinator.com");
		...
		Thread.sleep(5000);
		clip.partiendemograpicform1();
		Thread.sleep(5000);
		clip.clklockdocumentmodel();
		Thread.sleep(5000);
		clip.firstnamepatient2("Raj");
		Thread.sleep(5000);
		clip.lastnamepatient2("Singh");
		Thread.sleep(5000);
		clip.middlenamepatient2("Das");
		Thread.sleep(5000);
		clip.dateselectpatient2("05-09-2022");
		Thread.sleep(5000);
		clip.clicklockicon();
		Thread.sleep(5000);
		clip.enterpassword("Random@12345678");
		Thread.sleep(5000);
		clip.submitbutton1();
		Thread.sleep(5000);

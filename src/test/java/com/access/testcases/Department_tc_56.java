...
public class Department_tc_56 extends BaseClass {
	//Validate that if user hide Fill Out Documents dash and save the setting then it's refelection display in Dash from user access
	@Test

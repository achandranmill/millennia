...

{
	...
	public void Clipboard() throws Exception
	{
		...
		System.out.println("Initial Wait time displayed");
		r.WaitTime();
		Thread.sleep(5000);
		Thread.sleep(5000);
		r.StartPatient();
		...
		System.out.println("After start Wait time displayed");
		r.WaitTime();
		Thread.sleep(5000);
        r.HOLD();
		Thread.sleep(20000);
		...
		Assert.assertNotEquals(ExpectedText, Waittime.getText());
		System.out.println("After click Hold Wait time displayed");
		r.WaitTime();
		Thread.sleep(5000);

...
@Test
public class R_provider_tc_12 extends BaseClass

{
	...
	public void Provider() throws Exception
	{
		...
		pd.Credentials("MD");
		Thread.sleep(3000);
		pd.EmailAddress("rosani@mailinator.com");
		Thread.sleep(3000);
		...
		pd.Published();
		Thread.sleep(2000);
		pd.NationalProviderIdentifier_NPI("12345678");
		Thread.sleep(2000);
		pd.TaxpayerIdentificationNumber_TIN("12345678");
		Thread.sleep(2000);

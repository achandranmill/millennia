...
@Test
public class R_provider_tc_7 extends BaseClass

{
	public void Provider() throws Exception
	{
		...
		pd.Credentials("MD");
		Thread.sleep(3000);
		pd.EmailAddress("dinesh@mailinator.com");
		Thread.sleep(3000);
		...
		Thread.sleep(2000);
		pd.Provider_MatchingFirstIN();
		Thread.sleep(2000);
		pd.Provider_MatchingLastin();
		Thread.sleep(2000);
		pd.Provider_MatchingNewFieldin();
		Thread.sleep(2000);

...
public class Department_Reg_tc_91 extends BaseClass {
	...
	public void departments() throws InterruptedException, AWTException 
	{
		...
		Thread.sleep(5000);
		dept.regaddmore();
		dept.newaccountgender();
		Thread.sleep(5000);
		dept.regfieldsizegender();
		Thread.sleep(5000);
		dept.regtitlegender("Gender");
		Thread.sleep(5000);
		dept.regplaceholdergender("Gender Test");
		Thread.sleep(5000);
		dept.regrequiredgender();
		Thread.sleep(5000);

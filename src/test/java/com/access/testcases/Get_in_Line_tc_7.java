...
@Test
public class Get_in_Line_tc_7 extends BaseClass
...
//	pd.LocationPopup("Florida");
	...
	ap.linkAppointment();
	Thread.sleep(3000);
	WebElement Name=driver.findElement(By.xpath("//span[contains(text(),'gayke, chirag')]"));
    ...
    Thread.sleep(1000);
    WebElement Apptime=driver.findElement(By.xpath("//span[contains(text(),'11/16/2022 3:30 PM')]"));
	Assert.assertEquals(true, Apptime.isDisplayed());
	System.out.println("Apptime is Displayed- Assert Pass");
}
}

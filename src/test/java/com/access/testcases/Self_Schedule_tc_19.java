...
@Test
public class Self_Schedule_tc_19 extends BaseClass

{
	public void Clipboard() throws Exception
	{
		...
		if(listitem.matches("rathord meenu"))
		{
	      ...
	      Thread.sleep(10000);
	       boolean Hold = driver.findElement(By.xpath("/html/body/main/div[1]/registration/section/aside/button[4]")).isEnabled();
	       if(Hold)
	       {
	    	   System.out.println("Yes ! Element is Present but is Enabled");
	       }
	       else
	       {
	    	   System.out.println("Yes ! Element is Present but is Disabled");
	       }

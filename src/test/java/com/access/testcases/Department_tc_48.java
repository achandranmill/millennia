...
public class Department_tc_48 extends BaseClass {
	//Validate that if user hide discharge dash and save the setting then it's refelection display in Dash from user access
	@Test

...
public class Appt_tc_8 extends BaseClass
{
	...
	public void Appointments() throws Exception
	{
		...
		of.I_Want_To();
		Thread.sleep(5000);
		of.Cancel_This_Appointment();
		Thread.sleep(1000);
		of.Cancel_Appointment();
		Thread.sleep(1000);
		of.Yes_Cancel_Appointment();
		Thread.sleep(5000);
		WebElement Canceled = driver.findElement(By.xpath("//span[contains(text(),'CANCELED')]"));
		String Expected    = "CANCELED";
		Assert.assertEquals(Canceled.getText(), Expected);

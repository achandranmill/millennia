...
public class Department_Reg_tc_83 extends BaseClass {
	...
	public void departments() throws InterruptedException, AWTException 
	{
		...
		dept.reggender();
		Thread.sleep(5000);
		dept.reggenderfieldsize();
		Thread.sleep(5000);
		dept.reggendertitle("Gender");
		Thread.sleep(5000);
		dept.genderplaceholder("Gender Test");
		Thread.sleep(5000);
		dept.reggenderrequired();
		Thread.sleep(5000);

...
public class Reg_tc_6 extends BaseClass
{
	...
	//---------------Free Text ----------disable the free text
	...
	public void RegtPage() throws Exception
	{
		...
		try
		{
			WebElement Free_text_disabled = driver.findElement(By.xpath("/html/body/div[1]/div/div/send-s-m-s-modal/div[2]/form/div[1]/div[2]/ul[2]/li[2]"));
			Free_text_disabled.click();
		...
		{
			System.out.println("Free text Attribute is disabled");
		}

...
public class Massm_tc_25 extends BaseClass

{
	...
	public void MassMessaging() throws Exception
	{
		...
		Thread.sleep(2000);
		//User Enter Email
		addp.textemail("lee@mailinator.com");
		...
		m.Select_Message();
		m.Free_Text();
		m.Variable_Appointment_Time();
		m.Edit_Freetext_Message("  Mr. Ken your Appointment Time 09 AM is confirmed");
